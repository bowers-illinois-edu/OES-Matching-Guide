...
dm1 <- bmatch(t_ind=datmm_dm$trtbin, dist_mat=ps_dist_dm, solver=solverlist, subset_weight=1, n_controls=1)
...
datmm_dm$gradeLowHi <- ifelse(datmm_dm$grade %in% c(4,5,6), "hi", "lo")
